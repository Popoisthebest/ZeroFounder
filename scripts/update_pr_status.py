...
STATUS_LABELS = {
    ...
    "korean_font_not_installed": "PDF 한글 글꼴 미설치",
    "korean_font_not_found": "PDF 한글 글꼴 파일 없음",
    "korean_font_registration_failed": "PDF 한글 글꼴 등록 실패",
    "korean_font_missing_glyphs": "PDF 한글 글리프 검증 실패",
